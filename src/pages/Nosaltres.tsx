...
const events = [
    ...
    {
      year: "2019",
      title: "el de la distancia.",
      text: "El Sergi vivia a Madrid i la Paula a Barcelona. Ens vam tornar habituals del pont aeri i del Ave Madrid–Barcelona",
      image: foto2019,
    },
    {
      year: "2020",
    ...
    },
    {
      ...
      text: "I un desembre de 2024 amb els Alps francesos com a escenari perfecte, ens prometem! Tenim la sort de comptar amb el nostre portador del anillo particular, gràcies Deulo! I els nostres champagne showers, Carlos, Vall, Carmen i equipazo Valthorens <3",
      image: foto2024,
    },
    {
      year: "2025",
